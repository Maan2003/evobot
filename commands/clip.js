...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (!args.length) return message.channel.send(i18n.__("clip.usagesReply")).catch(console.error);
    ...
    if (!fs.existsSync(`./sounds/${args[0]}.mp3`)) return message.channel.send(i18n.__("common.errorCommand")).catch(console.error);
